"""12-minute activity log watcher — one summary line per minute."""
...
def main() -> None:
    ...
    with OUT.open("a", encoding="utf-8") as fp:
        for i in range(minutes):
            ...
            accounts = [e for e in batch if e.get("type") == "account"]
            summary = {
                "minute": i + 1,
                "ts": now,
                "events": len(batch),
                ...
                "last": [e.get("title") for e in batch[-5:]],
            }
